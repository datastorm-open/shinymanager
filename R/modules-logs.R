...
# Logs module modified for SQL database ----------------------------------------
...
logs_sql <- function(input, output, session, passphrase, 
...
# Logs module for SQLite from the original package -----------------------------
...
#' @importFrom shiny reactiveValues observe req updateSelectInput updateDateRangeInput reactiveVal outputOptions
#' @importFrom utils write.table
logs_sqlite <- function(input, output, session, sqlite_path, passphrase, 
                        fileEncoding = "", lan = NULL) {
