...
# Admin module modified for SQL database ---------------------------------------
...
# Admin module for SQLite from the original package ----------------------------
...
#' @importFrom DBI dbConnect
#' @importFrom RSQLite SQLite
admin_sqlite <- function(input, output, session, sqlite_path, passphrase, lan,
                         inputs_list = NULL, max_users = NULL) {
